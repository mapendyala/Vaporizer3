 ...
 */
public class DescribeSoftphoneLayoutCallType implements com.sforce.ws.bind.XMLizable , IDescribeSoftphoneLayoutCallType{
    ...
    public void setInfoFields(com.sforce.soap.partner.IDescribeSoftphoneLayoutInfoField[] infoFields) {
      this.infoFields = castArray(com.sforce.soap.partner.DescribeSoftphoneLayoutInfoField.class, infoFields);
    ...
    public void setScreenPopOptions(com.sforce.soap.partner.IDescribeSoftphoneScreenPopOption[] screenPopOptions) {
      this.screenPopOptions = castArray(com.sforce.soap.partner.DescribeSoftphoneScreenPopOption.class, screenPopOptions);
    ...
    public void setSections(com.sforce.soap.partner.IDescribeSoftphoneLayoutSection[] sections) {
      this.sections = castArray(com.sforce.soap.partner.DescribeSoftphoneLayoutSection.class, sections);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, screenPopsOpenWithin__typeInfo)) {
            setScreenPopsOpenWithin(__typeMapper.readString(__in, screenPopsOpenWithin__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
