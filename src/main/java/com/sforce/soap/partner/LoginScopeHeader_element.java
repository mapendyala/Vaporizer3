 ...
 */
public class LoginScopeHeader_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable , ILoginScopeHeader_element{
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, portalId__typeInfo)) {
            setPortalId(__typeMapper.readString(__in, portalId__typeInfo, java.lang.String.class));
        }
    }
