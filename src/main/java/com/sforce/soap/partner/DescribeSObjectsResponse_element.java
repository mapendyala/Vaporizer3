 ...
 */
public class DescribeSObjectsResponse_element implements com.sforce.ws.bind.XMLizable , IDescribeSObjectsResponse_element{
    ...
    public void setResult(com.sforce.soap.partner.IDescribeSObjectResult[] result) {
      this.result = castArray(com.sforce.soap.partner.DescribeSObjectResult.class, result);
      result__is_set = true;
    }
