 ...
 */
public class LoginResponse_element implements com.sforce.ws.bind.XMLizable , ILoginResponse_element{
    ...
    private static final com.sforce.ws.bind.TypeInfo result__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","result","urn:partner.soap.sforce.com","LoginResult",1,1,true);
    ...
    public void setResult(com.sforce.soap.partner.ILoginResult result) {
      this.result = (com.sforce.soap.partner.LoginResult)result;
      result__is_set = true;
    }
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.verifyElement(__in, result__typeInfo)) {
            setResult((com.sforce.soap.partner.LoginResult)__typeMapper.readObject(__in, result__typeInfo, com.sforce.soap.partner.LoginResult.class));
        }
    }
