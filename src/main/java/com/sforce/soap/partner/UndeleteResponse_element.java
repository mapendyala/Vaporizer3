 ...
 */
public class UndeleteResponse_element implements com.sforce.ws.bind.XMLizable , IUndeleteResponse_element{
    ...
    public void setResult(com.sforce.soap.partner.IUndeleteResult[] result) {
      this.result = castArray(com.sforce.soap.partner.UndeleteResult.class, result);
      result__is_set = true;
    }
