 ...
 */
public class QueryAll_element implements com.sforce.ws.bind.XMLizable , IQueryAll_element{

    /**
     * Constructor
     */
    public QueryAll_element() {}
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.verifyElement(__in, queryString__typeInfo)) {
            setQueryString(__typeMapper.readString(__in, queryString__typeInfo, java.lang.String.class));
        }
    }
