 ...
 */
public class RelatedListColumn implements com.sforce.ws.bind.XMLizable , IRelatedListColumn{
     ...
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo lookupId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","lookupId","http://www.w3.org/2001/XMLSchema","string",0,1,true);

    private boolean lookupId__is_set = false;
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeString(__out, lookupId__typeInfo, lookupId, lookupId__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.verifyElement(__in, format__typeInfo)) {
            setFormat(__typeMapper.readString(__in, format__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, lookupId__typeInfo)) {
            setLookupId(__typeMapper.readString(__in, lookupId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
