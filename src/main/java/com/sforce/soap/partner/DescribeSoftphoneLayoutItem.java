 ...
 */
public class DescribeSoftphoneLayoutItem implements com.sforce.ws.bind.XMLizable , IDescribeSoftphoneLayoutItem{
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.verifyElement(__in, itemApiName__typeInfo)) {
            setItemApiName(__typeMapper.readString(__in, itemApiName__typeInfo, java.lang.String.class));
        }
    }
