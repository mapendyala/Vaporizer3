 ...
 */
public class AssignmentRuleHeader_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable , IAssignmentRuleHeader_element{
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.verifyElement(__in, assignmentRuleId__typeInfo)) {
            setAssignmentRuleId(__typeMapper.readString(__in, assignmentRuleId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
