 ...
 */
public class DescribeDataCategoryGroupStructuresResponse_element implements com.sforce.ws.bind.XMLizable , IDescribeDataCategoryGroupStructuresResponse_element{
    ...
    public void setResult(com.sforce.soap.partner.IDescribeDataCategoryGroupStructureResult[] result) {
      this.result = castArray(com.sforce.soap.partner.DescribeDataCategoryGroupStructureResult.class, result);
      result__is_set = true;
    }
