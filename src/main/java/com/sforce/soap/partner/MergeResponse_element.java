 ...
 */
public class MergeResponse_element implements com.sforce.ws.bind.XMLizable , IMergeResponse_element{
    ...
    public void setResult(com.sforce.soap.partner.IMergeResult[] result) {
      this.result = castArray(com.sforce.soap.partner.MergeResult.class, result);
      result__is_set = true;
    }
