 ...
 */
public class PicklistForRecordType implements com.sforce.ws.bind.XMLizable , IPicklistForRecordType{
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.verifyElement(__in, picklistName__typeInfo)) {
            setPicklistName(__typeMapper.readString(__in, picklistName__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
