 ...
 */
public class MruHeader_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable , IMruHeader_element{
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.verifyElement(__in, updateMru__typeInfo)) {
            setUpdateMru(__typeMapper.readBoolean(__in, updateMru__typeInfo, boolean.class));
        }
    }
