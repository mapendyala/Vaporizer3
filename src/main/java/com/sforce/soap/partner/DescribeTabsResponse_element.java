 ...
 */
public class DescribeTabsResponse_element implements com.sforce.ws.bind.XMLizable , IDescribeTabsResponse_element{
    ...
    public void setResult(com.sforce.soap.partner.IDescribeTabSetResult[] result) {
      this.result = castArray(com.sforce.soap.partner.DescribeTabSetResult.class, result);
      result__is_set = true;
    }
