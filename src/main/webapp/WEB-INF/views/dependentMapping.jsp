					...
					<div class="mappingContainer" style="width: 100%;">
						<table id="masterTable" style="width: 100%;">
							...
							<tr>
								...
								<th class="table_header_details" style="float: center;">Child Entity</th>
								<th class="table_header_details" style="float: center;">Child Column</th>
								<th class="table_header_details" style="float: center;">Join Condition</th>
								<th class="table_header_details" style="float: center;">Child SFDC
									Object</th>
								<th class="table_header_details" style="float: center;">Child SFDC Object Lookup Field</th>
